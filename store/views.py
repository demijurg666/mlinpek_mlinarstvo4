...
#'store/izdavastvopdfs/prvopoglavljeproizvodnjapsenicnog.pdf'

def vademekumPdf(request):
    template_path = 'store/izdavastvopdfs/vademekumPdf.html'
    context = {}
    # Create a Django response object, and specify content_type as pdf
    response = HttpResponse(content_type='application/pdf')
    response['Content-Disposition'] = 'attachment; filename="Proizvodnja_psenicnog_brasna_sample.pdf"'
...
def prirucnikZaMlevenjeZitaPdf(request):
    template_path = 'store/izdavastvopdfs/prirucnikZaMlevenjeZitaPdf.html'
    context = {}
    # Create a Django response object, and specify content_type as pdf
    response = HttpResponse(content_type='application/pdf')
    response['Content-Disposition'] = 'attachment; filename="Proizvodnja_psenicnog_brasna_sample.pdf"'
...
def pesme(request):
    return render(request, 'store/pesme.html')
